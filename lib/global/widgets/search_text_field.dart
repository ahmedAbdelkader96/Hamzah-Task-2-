  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        border: OutlineInputBorder(borderRadius: BorderRadius.circular(36),borderSide: BorderSide(width: 1,color: Color(0xFF999999))),
        ...
        disabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(36),borderSide: BorderSide(width: 1,color: Color(0xFF999999))),
        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(36),borderSide: BorderSide(width: 1,color: Color(0xFF602465))),
